...
function dtse_front_init_step_one() {
	...
	wp_enqueue_script('dragtoshare-extended', DTSE_ROOT . 'js/wp-dragtoshare-extended.js', array('jquery', 'jquery-ui-core', 'jquery-ui-draggable','jquery-ui-droppable'), '1.0');
	return true;
}
...
function dtse_front_init_step_two() {
	...
	echo ' <link href="'. DTSE_ROOT .'css/wp-dragtoshare-extended.css" rel="stylesheet" type="text/css" media="screen" />'."\n";
	echo '<script type="text/javascript">
	jQuery(window).load(function(){
		dtsl.front.init();
		$dtsv.targetsLabel = \''.get_option('dtse_share').'\';
		$dtsv.tipsLabel = \''.get_option('dtse_tooptips').'\';
	}); </script>';
